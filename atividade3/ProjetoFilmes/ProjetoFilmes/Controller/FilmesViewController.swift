...
//------------------------------------------------------------------
	...
	override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
		if segue.identifier == "EditarCadastroSegue",let cadastroVC = segue.destination as? CadastroViewController,let filmeSelecionado = sender as? Filmes{ cadastroVC.filmeEditar = filmeSelecionado
		}
	}
